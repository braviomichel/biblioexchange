...
<head>
    ...
    <style>
        ...
        #userList, #bookList, #messageList, #reportList, #statistics, #settings, #logOut {
            margin-top: 10px;
            padding: 10px;
            border: 1px solid #ddd;
            border-radius: 5px;
        ...
        .user-item, .book-item, .message-item, .report-item, .statistic-item, .setting-item, .logout-item {
            margin-bottom: 10px;
            padding: 10px;
        ...
        .user-item h3, .book-item h3, .message-item h3, .report-item h3, .statistic-item h3, .setting-item h3, .logout-item h3 {
            margin-top: 0;
        }
...
<body>
    ...
    <div class="admin-dashboard">
        ...
        <div id="statistics">
            <h2>Statistiques</h2>
            <button><a href="statistiqueManagement.html">Charger les statistiques</a></button>
        </div>
    <script>
