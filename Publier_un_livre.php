...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO livres (titre_livre,auteur, année_de_publication, couverture, owner_id) VALUES (?, ?, ?, ?, ?)";

    // Préparation de la requête
    $stmt = $mysqli->prepare($sql);

    // Liaison des paramètres
    $stmt->bind_param("ssssi", $bookName, $author, $publicationYear, $image_url, $owner);
